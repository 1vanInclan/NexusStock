...
📋 Requerimientos Técnicos (User Stories)

1. Gestión de Productos (CRUD + Relaciones)

Debe haber Categorías y Productos. Un producto pertenece a una categoría.
Campos de Producto: Nombre, SKU (único), precio, stock actual y categoría.
Lógica: No se puede eliminar una categoría si tiene productos asociados (Integridad referencial).
